package cn.fmnx.oa.common.redis;

/**
 * @description:
 * @author: gmf
 * @date: Created in 2020/1/21 10:05
 * @version: redis工具类
 * @modified By:
 */
...
/**
 * 基于spring和redis的redisTemplate工具类 针对所有的hash 都是以h开头的方法
 * 针对所有的Set 都是以s开头的方法 不含通用方法
 * 针对所有的List 都是以l开头的方法
 */
@Component
@Slf4j
public class RedisUtil {@Autowired(required = false)
